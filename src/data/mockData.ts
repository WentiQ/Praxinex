...
export const INITIAL_CASES: RecoveryCase[] = [
  {
    ...
    aiWhy: 'Payment of ₹90,000 has been captured and settled via Razorpay. Revenue recovery complete.',
    ...
    timeline: [
      ...
      },
      {
        ...
        title: 'Payment Successfully Captured & Settled',
        description: 'Captured payment ₹90,000 via Razorpay. Invoice #1 marked paid.',
        type: 'success'
      }
    ]
  },
  {
    ...
    maxAttempts: 3,
    recoveryProbability: 100,
    aiWhy: 'Payment of ₹10,000 has been captured and settled via Razorpay. Revenue recovery complete.',
    aiPolicyNote: 'Revenue recovered. No action required.',
    policyAllowed: true,
    ...
    timeline: [
      ...
      },
      {
        ...
        title: 'Payment Link Settled Successfully',
        description: 'Payment link plink_TUPl2G0SbZxwmC captured ₹10,000 via UPI.',
        type: 'success'
      }
    ]
  },
